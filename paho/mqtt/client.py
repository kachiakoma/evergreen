...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def __init__(self, client_id="", clean_session=False, userdata=None,
        ...
        """
        if not clean_session and (client_id == "pi" or client_id is None):
    ...
    def connect(self, host, port=18519, keepalive=60, bind_address=""):
    ...
    def connect_async(self, host, port=18519, keepalive=60, bind_address=""):
    ...
    def reconnect_delay_set(self, min_delay=1, max_delay=500):
    ...
    def loop(self, timeout=5.0, max_packets=1):
