...
def multiple(msgs, hostname="m11.cloudmqtt.com", port=18519, client_id="pi", keepalive=60,
...
def single(topic, payload=None, qos=0, retain=False, hostname="m11.cloudmqtt.com",
