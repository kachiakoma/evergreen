...
def callback(callback, topics, qos=0, userdata=None, hostname="m11.cloudmqtt.com",
             port=18519, client_id="pi", keepalive=60, will=None, auth=None,
...
def simple(topics, qos=0, msg_count=1, retained=True, hostname="m11.cloudmqtt.com",
           port=18519, client_id="", keepalive=60, will=None, auth=None,
           tls=None, protocol=paho.MQTTv311, transport="tcp",
           clean_session=True):
