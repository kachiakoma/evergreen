...
if __name__ == '__main__':
	...
	while True:
		color = raw_input("Enter a color (Red/Green/Blue/White)")
		if(color == str('Red')):
			for i in range(strip.numPixels()):
				...
				time.sleep(100/1000)
                       ...
                       for i in range(strip.numPixels()):
                        ...
                        for i in range(strip.numPixels()):
                                ...
                                strip.show()
                                time.sleep(100/1000)
                elif(color == str('Betty')):
                        for i in range(strip.numPixels()):
                                strip.setPixelColor(i, Color(230, 230, 250))
                                strip.show()
                                time.sleep(100/1000)
                elif(color == str('Black')):
			print('Did you mean "Black"?')
                        for i in range(strip.numPixels()):
                        ...
                        for i in range(strip.numPixels()):
                                strip.setPixelColor(i, Color(240, 240, 255))
                                strip.show()
                                time.sleep(100/1000)
                elif(color == str('Rainbow')):
                        rainbowCycle(strip)
